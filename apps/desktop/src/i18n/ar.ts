...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      openFolderTitle: 'فتح المجلد كمشروع',
      pathLabel: 'مسار مجلد المشروع',
      pathPlaceholder: '~/المسار/إلى/المشروع',
      pathHelp: 'أدخل مسارًا في نظام ملفات الطرفية لهذا الملف الشخصي. سيتم التحقق منه عند الإرسال.',
      pathLoading: 'جارٍ التحقق من مكان تخزين مجلدات المشاريع لهذا الملف الشخصي…',
      pathAdd: 'إضافة المسار',
      pathError: 'تعذر تحديد مسار المجلد.',
