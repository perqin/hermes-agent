...
export const ru = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      openFolderTitle: 'Открыть папку как проект',
      pathLabel: 'Путь к папке проекта',
      pathPlaceholder: '~/путь/к/проекту',
      pathHelp: 'Введите путь в файловой системе терминала этого профиля. Он будет проверен при отправке.',
      pathLoading: 'Проверяем, где этот профиль хранит папки проектов…',
      pathAdd: 'Добавить путь',
      pathError: 'Не удалось разрешить путь к папке.',
