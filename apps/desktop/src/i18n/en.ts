...
export const en: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      pathHelp: 'Enter a path in this profile’s terminal filesystem. It will be validated when submitted.',
      pathLoading: 'Checking where this profile stores project folders…',
      pathAdd: 'Add path',
      pathError: 'The folder path could not be resolved.',
