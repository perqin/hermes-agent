...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      openFolderTitle: 'フォルダをプロジェクトとして開く',
      pathLabel: 'プロジェクトフォルダのパス',
      pathPlaceholder: '~/プロジェクト/パス',
      pathHelp: 'このプロファイルのターミナルファイルシステム上のパスを入力してください。送信時に検証されます。',
      pathLoading: 'このプロファイルのプロジェクトフォルダの場所を確認しています…',
      pathAdd: 'パスを追加',
      pathError: 'フォルダのパスを解決できませんでした。',
